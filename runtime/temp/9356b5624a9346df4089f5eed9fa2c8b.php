<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/train/live/edit.html";i:1514519378;s:81:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/layout/default.html";i:1514519378;s:78:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/common/meta.html";i:1514519378;s:80:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/common/script.html";i:1514519378;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-date" data-rule="required" class="form-control" name="row[date]" type="text" value="<?php echo $row['date']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-time" class="control-label col-xs-12 col-sm-2"><?php echo __('Time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[time]" type="text" value="<?php echo datetime($row['time']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-tags" data-rule="required" class="form-control" name="row[tags]" type="text" value="<?php echo $row['tags']; ?>" data-tip="以英文逗号分开,例1,2">
        </div>
    </div>
    <div class="form-group">

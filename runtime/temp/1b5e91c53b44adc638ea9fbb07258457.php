<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/questions/edit.html";i:1514873988;s:81:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/layout/default.html";i:1514519378;s:78:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/common/meta.html";i:1514519378;s:80:"/home/wwwroot/fire.mcykj.com/public/../application/admin/view/common/script.html";i:1514519378;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-title" class="form-control summernote edit" rows="5" name="row[title]" cols="50"><?php echo $row['title']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-analysis" class="form-control summernote edit" rows="5" name="row[analysis]" cols="50"><?php echo $row['analysis']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="form-inline" data-toggle="cxselect" data-selects="one,two,tree,four,five">
                <select class="one form-control" name="row[category][0]" data-url="ajax/category?pid=0">
                    <option value="<?php if(empty($row['category']['0']) != true): ?><?php echo $row['category']['0']; endif; ?>" selected=""></option>
                </select>
                <select class="two form-control" name="row[category][1]" data-url="ajax/category" data-query-name="pid">
                    <option value="<?php if(empty($row['category']['1']) != true): ?><?php echo $row['category']['1']; endif; ?>" selected=""></option>
                </select>
                <select class="tree form-control" name="row[category][2]" data-url="ajax/category" data-query-name="pid">
                    <option value="<?php if(empty($row['category']['2']) != true): ?><?php echo $row['category']['2']; endif; ?>" selected=""></option>
                </select>
                <select class="four form-control" name="row[category][3]" data-url="ajax/category" data-query-name="pid">
                    <option value="<?php if(empty($row['category']['3']) != true): ?><?php echo $row['category']['3']; endif; ?>" selected=""></option>
                </select>
                <select class="five form-control" name="row[category][4]" data-url="ajax/category" data-query-name="pid">
                    <option value="<?php if(empty($row['category']['4']) != true): ?><?php echo $row['category']['4']; endif; ?>" selected=""></option>
                </select>
            </div>
        </div>
    </div>

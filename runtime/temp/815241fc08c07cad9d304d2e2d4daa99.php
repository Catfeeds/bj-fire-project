...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-title" data-rule="required" class="form-control " rows="3" name="row[title]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-analysis" data-rule="required" class="form-control" name="row[analysis]" type="text">
        </div>
    </div>
    <div class="form-group">
